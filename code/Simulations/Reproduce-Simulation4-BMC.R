...
Sim4_LS_M1_BMC <- run_one_WS_model(model_name = "Sim4-M1", seed_vec = Model1_seed, m = 10, K = 3, zeta = 0.2,
                               data_dim = data_dim, dist_class = dist_class)

Sim4_LS_M2_BMC <- run_one_WS_model(model_name = "Sim4-M2", seed_vec = Model2_seed, m = 10, K = 5, zeta = 0.2,
                               data_dim = data_dim, dist_class = dist_class)

Sim4_LS_M3_BMC <- run_one_WS_model(model_name = "Sim4-M3", seed_vec = Model3_seed, m = 20, K = 3, zeta = 0.2,
                               data_dim = data_dim, dist_class = dist_class)

Sim4_LS_M4_BMC <- run_one_WS_model(model_name = "Sim4-M4", seed_vec = Model4_seed, m = 20, K = 5, zeta = 0.2,
                               data_dim = data_dim, dist_class = dist_class)

save(Sim4_WS_M1_BMC, Sim4_WS_M2_BMC, Sim4_WS_M3_BMC, Sim4_WS_M4_BMC, 
     Sim4_LS_M1_BMC, Sim4_LS_M2_BMC, Sim4_LS_M3_BMC, Sim4_LS_M4_BMC, 
